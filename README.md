...
Let's look at the example for MLflow model, being trained by MLflow and served with KServe.
...
- Get the example code
  ...
  Under `codesets/mlflow/sklearn` directory there is the example MLflow project. It is a slightly modified example based on [upstream MLflow](https://github.com/mlflow/mlflow/tree/master/examples).
