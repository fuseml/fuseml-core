...
// Endpoints wraps the "runnable" service endpoints.
...
// NewEndpoints wraps the methods of the "runnable" service with endpoints.
...
// Use applies the given middleware to all the "runnable" service endpoints.
