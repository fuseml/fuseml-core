...
//
// runnable client HTTP transport
//
// Command:
...
// Client lists the runnable service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the runnable service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// List returns an endpoint that makes HTTP requests to the runnable service
// list server.
func (c *Client) List() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("runnable", "list", err)
		}
		return decodeResponse(resp)
	}
}

// Register returns an endpoint that makes HTTP requests to the runnable
...
func (c *Client) Register() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("runnable", "register", err)
		}
		return decodeResponse(resp)
	}
}

// Get returns an endpoint that makes HTTP requests to the runnable service get
// server.
func (c *Client) Get() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("runnable", "get", err)
		}
		return decodeResponse(resp)
	}
}
