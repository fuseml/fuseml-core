...
// Server lists the runnable service endpoint HTTP handlers.
type Server struct {
	Mounts   []*MountPoint
	List     http.Handler
...
// New instantiates HTTP handlers for all the runnable service endpoints using
...
func (s *Server) Service() string { return "runnable" }
...
// Mount configures the mux to serve the runnable endpoints.
...
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/runnables", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "runnable" service "list" endpoint.
func NewListHandler(
...
// MountRegisterHandler configures the mux to serve the "runnable" service
// "register" endpoint.
...
// MountGetHandler configures the mux to serve the "runnable" service "get"
// endpoint.
func MountGetHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/runnables/{runnableNameOrId}", f)
}

// NewGetHandler creates a HTTP handler which loads the HTTP request and calls
// the "runnable" service "get" endpoint.
func NewGetHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
