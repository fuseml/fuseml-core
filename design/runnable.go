...
// RunnableImplem describes the runnable implementation
var RunnableImplem = Type("RunnableImplem", func() {
...
var Runnable = Type("Runnable", func() {
	...
	Field(4, "implem", RunnableImplem, "Runnable implementation")
	...
	Field(8, "implem", RunnableImplem, "Runnable implementation")
	Field(9, "outputs", MapOf(String, RunnableOutput), "Map of outputs (artifacts, parameters) generated by this runnable, indexed by name", func() {
		Key(func() {
			Pattern(`^[A-Za-z0-9-_]+$`)
		})
	})
	Field(10, "created", String, "The runnable's creation time", func() {
		Format(FormatDateTime)
		Example("2021-04-09T06:17:25Z")
	})
	Field(11, "labels", MapOf(String, String),
